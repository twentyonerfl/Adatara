            ...
            {(() => {
              ...
              if (layout === "grid" || layout === "grid-2") {
                return (
                  <div className="grid grid-cols-2 gap-2">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className="aspect-[4/3] rounded-xl overflow-hidden border border-white/20 shadow-sm">
              ...
              if (layout === "grid-3") {
                return (
                  <div className="grid grid-cols-3 gap-1.5">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.03} className="aspect-square rounded-lg overflow-hidden border border-white/20 shadow-sm">
                        <img src={g} alt="" className="w-full h-full object-cover" />
                      </ScrollReveal>
                    ))}
                  </div>
              ...
              if (layout === "masonry") {
                return (
                  <div className="columns-2 gap-2 space-y-2">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="fade-up" duration={0.6} delay={i * 0.04} className="break-inside-avoid block mb-2">
              ...
              if (layout === "carousel") {
                return (
                  <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none snap-x snap-mandatory">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.05} className="w-[160px] shrink-0 snap-center">
                ...
                return (
                  <div className="relative">
                    <div className={`${scrollH} overflow-y-auto grid ${colsClass} gap-2 pr-1 scrollbar-thin scrollbar-thumb-white/30 scrollbar-track-transparent`}
                      ...
                      {galeris.map((g, i) => (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className="aspect-square rounded-xl overflow-hidden border border-white/20 shadow-sm shrink-0">
                          <img src={g} alt="" className="w-full h-full object-cover" />
                        </ScrollReveal>
                      ))}
                    </div>
                ...
                return (
                  <div className="grid grid-cols-6 gap-2">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className={`${colSpan} overflow-hidden rounded-xl border border-white/20 shadow-sm`}>
                          <img src={g} alt="" className="w-full h-full object-cover" />
                        </ScrollReveal>
                      );
                    })}
                ...
                return (
                  <div className="grid grid-cols-6 gap-x-2 gap-y-4 pt-1 pb-4">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className={`${gridClass} border-2 border-white shadow-lg overflow-hidden rounded-none`}>
                          <img src={g} alt="" className="w-full h-full object-cover" />
                        </ScrollReveal>
                      );
                    })}
                ...
                return (
                  <div className="grid grid-cols-2 gap-3.5 pt-1">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className={`bg-white p-1.5 pb-4 shadow-md border border-black/5 ${rot} transition-transform hover:rotate-0 duration-300`}>
              ...
              if (layout === "grid-4") {
                return (
                  <div className="grid grid-cols-4 gap-1 pt-1">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.03} className="aspect-square rounded-md overflow-hidden border border-white/20 shadow-sm">
                        <img src={g} alt="" className="w-full h-full object-cover" />
                      </ScrollReveal>
                    ))}
                  </div>
              ...
              if (layout === "masonry-3") {
                return (
                  <div className="columns-3 gap-1.5 space-y-1.5 pt-1">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="fade-up" duration={0.6} delay={i * 0.04} className="break-inside-avoid block mb-1.5">
                    ...
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className={`flex ${isEven ? "justify-start" : "justify-end"}`}>
                          <ScrollReveal animationType={isEven ? "fade-right" : "fade-left"} duration={0.6} delay={0.05} className="w-[85%] aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border border-white/25 transform hover:scale-[1.02] transition-transform duration-300 block">
                            <img src={g} alt="" className="w-full h-full object-cover" />
                          </ScrollReveal>
                        </div>
                      );
                ...
                return (
                  <div className="grid grid-cols-2 gap-4 pt-1">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.7} delay={i * 0.05} className={`${bubbleClass} overflow-hidden border-2 border-white shadow-md transition-all duration-300`}>
                          <img src={g} alt="" className="w-full h-full object-cover" />
                        </ScrollReveal>
                      );
                    })}
                ...
                return (
                  <div className="space-y-6 pt-2 pb-6 relative">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.7} delay={i * 0.05} className={`${offsetClass} aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-white/30 transform hover:rotate-0 transition-all duration-500`}>
                          <img src={g} alt="" className="w-full h-full object-cover" />
                        </ScrollReveal>
                      );
                    })}
                    ...
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className="flex justify-center">
                          <ScrollReveal animationType="zoom-in" duration={0.7} delay={0.05} className={`w-[85%] bg-white p-2.5 pb-6 shadow-xl border border-black/5 rounded-none transform ${rotation} hover:rotate-0 transition-transform duration-300 block`}>
                            <img src={g} alt="" className="w-full aspect-square object-cover" />
              ...
              if (layout === "classic-frame") {
                return (
                  <div className="grid grid-cols-2 gap-4 pt-1">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className="aspect-[3/4] rounded-lg overflow-hidden bg-white p-2 shadow-lg border-2 border-[#d4af37]/30 hover:border-[#d4af37] transition-all duration-300">
              ...
              if (layout === "filmstrip") {
                return (
                  <div className="flex gap-2 overflow-x-auto bg-neutral-900 py-3 px-2 border-y-4 border-dashed border-neutral-700 scrollbar-none snap-x snap-mandatory pt-1">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.05} className="w-[130px] aspect-square shrink-0 bg-black relative border-x border-neutral-800 snap-center flex items-center justify-center p-1">
                        <img src={g} alt="" className="w-full h-full object-cover" />
              ...
              if (layout === "highlight-first") {
                ...
                return (
                  <div className="space-y-2 pt-1">
                    {first && (
                      <ScrollReveal animationType="zoom-in" duration={0.8} className="w-full aspect-[16/9] rounded-2xl overflow-hidden border border-white/20 shadow-md block">
                    ...
                    {others.length > 0 && (
                      <div className="grid grid-cols-3 gap-1.5">
                        {others.map((g, i) => (
                          <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className="aspect-square rounded-lg overflow-hidden border border-white/10 shadow-sm">
                            <img src={g} alt="" className="w-full h-full object-cover" />
                          </ScrollReveal>
                        ))}
                      </div>
                ...
                return (
                  <div className={`grid grid-cols-6 ${customGap} pt-1 pb-4`}>
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <ScrollReveal key={i} animationType="zoom-in" duration={0.6} delay={i * 0.04} className={`${colSpan} ${aspect} ${rotate} ${styleClass} overflow-hidden transition-all duration-300`}>
