        ...
        {galeris.length > 0 ? (
          <div className="mt-5">
            {(() => {
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    {galeris.map((g, i) => (
                      <div key={i} className="mb-1.5">
                        <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.04}>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {galeris.map((g, i) => (
                      <div key={i} className="mb-1">
                        <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.03}>
              ...
              if (layout === "masonry") {
                return (
                  <div className="columns-2 gap-2.5 space-y-1.5">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="fade-up" duration={2} delay={i * 0.04}>
              ...
              if (layout === "carousel") {
                return (
                  <div className="flex gap-2.5 overflow-x-auto pb-2 scrollbar-none snap-x snap-mandatory">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="zoom-in" duration={2} delay={i * 0.05}>
              ...
              if (layout === "scroll") {
                ...
                return (
                  <div className="relative">
                    <div className={`${scrollH} overflow-y-auto grid ${colsClass} gap-2.5 pr-1 scrollbar-thin scrollbar-thumb-white/30 scrollbar-track-transparent`}
                ...
                return (
                  <div className="grid grid-cols-6 gap-2.5">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className={`${colSpan} mb-1.5`}>
                          <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.04}>
              ...
              if (layout === "aesthetic") {
                return (
                  <div className="grid grid-cols-6 gap-2.5 pt-1 pb-4">
                    {galeris.map((g, i) => {
                      let gridClass = "";
                      if (i % 7 === 0) {
                      ...
                      return (
                        <div key={i} className={`${gridClass} mb-1.5`}>
                          <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.04}>
              ...
              if (layout === "masonry-3") {
                return (
                  <div className="columns-3 gap-1.5 space-y-1 pt-1">
                    {galeris.map((g, i) => (
                      <ScrollReveal key={i} animationType="fade-up" duration={2} delay={i * 0.04}>
                ...
                return (
                  <div className="space-y-2 pt-1">
                    {galeris.map((g, i) => {
                      const isEven = i % 2 === 0;
                      return (
                        <ScrollReveal key={i} animationType={isEven ? "fade-right" : "fade-left"} duration={2} delay={0.05}>
                          <div className={`flex ${isEven ? "justify-start" : "justify-end"} mb-2`}>
                ...
                return (
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className="mb-2">
                          <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.05}>
              ...
              if (layout === "parallax-floating") {
                return (
                  <div className="space-y-3 pt-2 pb-4 relative">
                    {galeris.map((g, i) => {
                ...
                return (
                  <div className="space-y-3 pt-1">
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className="mb-3">
                          <ScrollReveal animationType="zoom-in" duration={2} delay={0.05}>
              ...
              if (layout === "highlight-first") {
                ...
                return (
                  <div className="space-y-2 pt-1">
                    {first && (
                      <ScrollReveal animationType="zoom-in" duration={2}>
                        <div className="w-full aspect-[16/9] rounded-2xl overflow-hidden border border-white/20 shadow-md mb-2">
              ...
              if (layout === "custom") {
                ...
                if (rawCustomGap === "gap-0") { gapClass = "gap-0"; mbClass = "mb-0"; }
                else if (rawCustomGap === "gap-1") { gapClass = "gap-1"; mbClass = "mb-1"; }
                else if (rawCustomGap === "gap-2") { gapClass = "gap-2"; mbClass = "mb-1.5"; }
                else if (rawCustomGap === "gap-3") { gapClass = "gap-3"; mbClass = "mb-2"; }
                else if (rawCustomGap === "gap-4") { gapClass = "gap-4"; mbClass = "mb-3"; }
                else if (rawCustomGap === "gap-6") { gapClass = "gap-6"; mbClass = "mb-4"; }
                else if (rawCustomGap === "gap-8") { gapClass = "gap-8"; mbClass = "mb-6"; }

                return (
                  <div className={`grid grid-cols-6 ${gapClass} pt-1 pb-4`}>
                    {galeris.map((g, i) => {
                      ...
                      return (
                        <div key={i} className={`${colSpan} ${mbClass}`}>
                          <ScrollReveal animationType="zoom-in" duration={2} delay={i * 0.04}>
